    ...
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <div className={styles.bigValue}>
          <span className="mono">{stats.avgConsumption !== null ? num(stats.avgConsumption, 1) : '—'}</span>
          <small>л/100км</small>
        </div>
        <div className={styles.heroSub}>
          {stats.lastConsumption !== null ? `Последно: ${num(stats.lastConsumption, 1)} л/100км` : 'Добави 2 пълни зареждания за разход'}
        </div>
      </div>
